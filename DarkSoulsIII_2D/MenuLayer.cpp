...
void MenuLayer::init() {
	...
	background = new Background("res/menu/background_menu.png", WIDTH * 0.5, HEIGHT * 0.5, game);
	title = new Actor("res/menu/logo.png", WIDTH * 0.5, HEIGHT * 0.4, 650, 133, game);
	button = new Actor("res/menu/boton_jugar.png", WIDTH * 0.5, HEIGHT * 0.6, 232, 112, game);
	playingMusic = false;
}
...
void MenuLayer::playMusic() {
	if (!playingMusic)
	{
		audioBackground = Audio::createAudio("res/music/DarkSouls3OSTMainTheme.mp3", true);
